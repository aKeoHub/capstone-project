...
CREATE TABLE IF NOT EXISTS `capstonedb`.`event` (
	...
	INSERT INTO `user` (`username`,`firstname`,`lastname`,`password`,`email`,`picture_id`,`create_date`) 
		VALUES ('Tester123','Test','Test1','password','test@gmail.com',NULL,'2022-09-16');
	INSERT INTO `user` (`username`,`firstname`,`lastname`,`password`,`email`,`picture_id`,`create_date`) 
		VALUES ('Tester456','Test2','Test2','password','test2@gmail.com',NULL,'2022-09-19');
...
-- 		VALUES (1, 1, 'PARK RULES AD GUIDELINES','2020-03-19','This document explains basic park guidelines', NULL);	
-- 	INSERT INTO `park_document` (`document_category`,`creator_id`,`document_name`,`create_date`,`description`,`file`) 
-- 		VALUES (1, 2, 'PARK EVENTS POLICY','2021-07-12','This document explains hosting events', NULL);
	...
	INSERT INTO `event` (`category_id`,`event_creator`,`event_name`,`location`,`description`, `start_date`, `end_date`, `file`) 
		VALUES (2, 1, 'Taylor Swift', 'Main Square', 'Taylor Swift is coming later this year!','2022-11-10','2022-11-10', NULL);
	INSERT INTO `event` (`category_id`,`event_creator`,`event_name`,`location`,`description`, `start_date`, `end_date`, `file`) 
		VALUES (2, 2, 'Comedy Show', 'North Field', 'We have some local comedians coming','2022-05-20','2022-05-20', NULL);
